  ...
  <div class="header">
      <div class="header-container">
            ...
            <div class="link-align">
                <?php foreach ($menu as $menu_item){?>
                    <div class="link-container">
                        <div class="link">
                            <a href="<?php echo $menu_item ["link"]["url"]?>">
            ...
            <div class="align">
                <?php foreach($icon as $icons){ ?>
                    <div class="wrap">
                        <div class="image">
                            <a href="<?php echo $icons ["links"]["url"]?>">
                                <img src="<?php echo $icons['icons']['url'];?>">
                            </a>
                        </div>
                    </div>
                <?php }?>
    ...
    <div class="mobile-container">
          <div class="logo-mobile">
                ...
                <div class="hamburger-open"><svg width="30" height="30" viewBox="0 0 30 30" fill="#FFF" xmlns="http://www.w3.org/2000/svg">
                <g opacity="1">
